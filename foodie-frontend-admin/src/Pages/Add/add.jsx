...
const Add = () => {
  ...
  const token = "eyJhbGciOiJIUzM4NCJ9.eyJzdWIiOiIxIiwiaWF0IjoxNzM4MjIwODk5LCJleHAiOjE3MzgyMjI2OTl9.TfbVIsZufS9DDiXY6JWuRyp3dNUX0JDJ3_ekYzzKWmmZdWNDb0j-ERkQA5pBpIH0";
      ...
      <div className="add">
        ...
        <div className={`alert-box ${alertType} slide-in`}>
          <div className="alert-content">
            <img 
              src={alertType === 'success' ? assets.succes_icon : assets.error_icon} 
              alt={alertType}
            />
